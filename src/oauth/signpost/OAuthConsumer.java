 ...
 * and secret. Refer to {@link oauth.signpost.OAuthProvider} how to retrieve a valid token and
 * token secret.
 * </p>
 * <p>
...
public interface OAuthConsumer extends Serializable {
     ...
     * @param messageSigner
     *        the signer
     * @see oauth.signpost.signature.HmacSha1MessageSigner
     * @see oauth.signpost.signature.PlainTextMessageSigner
     */
     ...
     * {@link oauth.signpost.signature.SigningStrategy} will then take care of writing them to the
     ...
     *        the strategy
     * @see oauth.signpost.signature.AuthorizationHeaderSigningStrategy
     * @see oauth.signpost.signature.QueryStringSigningStrategy
     */
     ...
     * {@link oauth.signpost.OAuthProvider#retrieveRequestToken}, try setting this to true.
     * </p>
     * 
     * @param enable
     *        true or false
     ...
     * depends on the current {@link oauth.signpost.signature.SigningStrategy}.
     * 
     * @param request
     *        the request to sign
