 ...
 * {@link oauth.signpost.OAuthConsumer} to sign the token request message; after a token has
 ...
 * if the request was out-of-band (cf. {@link oauth.signpost.OAuth#OUT_OF_BAND}.
 * </p>
 * <p>
 * The consumer used during token handshakes is now ready for signing.
 * </p>
 * 
 * @see oauth.signpost.basic.DefaultOAuthProvider
 * @see oauth.signpost.basic.DefaultOAuthConsumer
 * @see oauth.signpost.OAuthProviderListener
 */
public interface OAuthProvider extends Serializable {
     ...
     * <p>
     * <b>Pre-conditions:</b> the given {@link oauth.signpost.OAuthConsumer} must have a valid
     * consumer key and consumer secret already set.
     * </p>
     * <p>
     * <b>Post-conditions:</b> the given {@link oauth.signpost.OAuthConsumer} will have an
     * unauthorized request token and token secret set.
     * </p>
     * 
     * @param consumer
     *        the {@link oauth.signpost.OAuthConsumer} that should be used to sign the request
     * @param callbackUrl
     ...
     *        Pass {@link oauth.signpost.OAuth.OUT_OF_BAND} if the service provider implements
     ...
     *        {@link oauth.signpost.OAuth.OUT_OF_BAND}, then you must ask the user for this
     ...
     * DEPRECATED. Use {@link oauth.signpost.OAuthProviderListener} to customize requests.
     * 
     * @param header
     ...
     *             {@link oauth.signpost.OAuthProviderListener} to customize requests.
