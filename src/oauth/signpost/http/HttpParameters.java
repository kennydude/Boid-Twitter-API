 ...
 * {@link java.util.SortedSet} of parameters collected from the request during message
...
public class HttpParameters implements Map<String, SortedSet<String>>, Serializable {
     ...
     * {@link oauth.signpost.OAuth#percentEncode(String)}, otherwise the lookup will fail
