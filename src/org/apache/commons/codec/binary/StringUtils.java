...
public class StringUtils {
     ...
     */
    private static byte[] getBytes(String string, String charset) throws UnsupportedEncodingException {
        if (string == null) {
            return null;
        }
     ...
     */
    public static byte[] getBytesIso8859_1(String string) throws UnsupportedEncodingException {
     ...
     * @see #getBytesUnchecked(String, String)
     */
    public static byte[] getBytesUsAscii(String string) throws UnsupportedEncodingException {
     ...
     * @see #getBytesUnchecked(String, String)
     */
    public static byte[] getBytesUtf16(String string) throws UnsupportedEncodingException {
     ...
     * @see #getBytesUnchecked(String, String)
     */
    public static byte[] getBytesUtf16Be(String string) throws UnsupportedEncodingException {
     ...
     * @see #getBytesUnchecked(String, String)
     */
    public static byte[] getBytesUtf16Le(String string) throws UnsupportedEncodingException {
     ...
     * @since As of 1.7, throws {@link NullPointerException} instead of UnsupportedEncodingException
     */
    public static String newStringUsAscii(byte[] bytes) throws UnsupportedEncodingException {
     ...
     * @since As of 1.7, throws {@link NullPointerException} instead of UnsupportedEncodingException
     */
    public static String newStringUtf16(byte[] bytes) throws UnsupportedEncodingException {
     ...
     * @since As of 1.7, throws {@link NullPointerException} instead of UnsupportedEncodingException
     */
    public static String newStringUtf16Be(byte[] bytes) throws UnsupportedEncodingException {
     ...
     * @since As of 1.7, throws {@link NullPointerException} instead of UnsupportedEncodingException
     */
    public static String newStringUtf16Le(byte[] bytes) throws UnsupportedEncodingException {
